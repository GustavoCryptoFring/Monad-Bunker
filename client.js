...
// Массив историй для случайного выбора
const gameStories = [
    {
        title: 'Потерянный радиопередатчик',
        description: 'Вы находите обломки старого радиопередатчика, по легенде передавшего последний сигнал выживших перед большим событием. Теперь вам предстоит решить, кто достоин остаться в бункере...'
    },
    {
        title: 'Тайная лаборатория', 
        description: 'Где-то под бункером скрыта заброшенная лаборатория. Говорят, там остались образцы неизвестного вируса. Ресурсы ограничены, и не все смогут выжить...'
    },
    {
        title: 'Последние запасы',
        description: 'Запасы еды и воды подходят к концу. Система жизнеобеспечения работает на пределе. Время принимать сложные решения о том, кто останется...'
    },
    {
        title: 'Сигнал спасения',
        description: 'По радио поступил сигнал - спасательная команда придет через неделю, но места в транспорте ограничены. Кого взять с собой?'
    },
    {
        title: 'Зараженная зона',
        description: 'Радиационный фон снаружи критически высок. Бункер - единственное безопасное место, но ресурсов хватит не на всех...'
    }
];
