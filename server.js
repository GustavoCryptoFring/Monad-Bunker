...
const gameScenarios = [
    {
        ...
        icon: "☢️",
        bunkerDescription: "Ваш бункер оборудован современной системой очистки воздуха и радиационными фильтрами. В нём есть подземная ферма с гидропонными установками для выращивания овощей и зелени, что обеспечит вас свежей пищей. Также имеется игровая комната с различными настольными играми, книгами и развлечениями для поддержания морального духа во время долгого заточения.",
        rooms: [
            { name: "Ферма", icon: "🌱" },
    ...
    },
    {
        ...
        icon: "🧊",
        bunkerDescription: "Ваш бункер имеет мощную систему отопления и теплоизоляцию. В нём находится бильярдная комната, где можно проводить время за игрой и общением, поддерживая социальные связи. Также есть полностью оборудованная лаборатория для научных исследований и экспериментов, которая поможет найти способы выжить в новых климатических условиях и возможно найти решение проблемы глобального похолодания.",
        rooms: [
            { name: "Бильярд", icon: "🎱" },
